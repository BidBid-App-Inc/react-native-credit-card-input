...
export default class CardView extends Component {
  static propTypes = {
    ...
    iconPaypal: PropTypes.number,
    bgPaypal: PropTypes.number,
  ...
  static defaultProps = {
    ...
    iconPaypal: require("../images/card-back.png"),
    bgPaypal: require("../images/card-back.png"),
  };
        ...
        <View style={[s.cardContainer, containerSize]}>
          <FlipCard style={{ borderWidth: 0 }}
            ...
            <ImageBackground style={[BASE_SIZE, s.cardFace, transform]}
              ...
              <Text style={[s.baseText, { fontFamily }, s.mailPaypal, !name && s.placeholder, focused === "name" && s.focused]}
                    numberOfLines={1}>
                { !name ? placeholder.mail : name }
              </Text>
            </ImageBackground>
            <ImageBackground style={[BASE_SIZE, s.cardFace, transform]}
                             source={bgPaypal}>
